...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    @Override
    public native void screenShot(String path);  //截图功能 --add by yangqi-20180109

    @Override
    public native void setMuted(boolean muted);  //静音功能 --add by yangqi-20180109

    @Override
    public native void setAVReadTimeout(int seconds);
